    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-full bg-[var(--input-bg)] py-2.5 pl-9 pr-4 text-base text-[var(--mag-ink)] placeholder:text-[var(--mag-ink-muted)] focus:outline-none focus:bg-[var(--mag-card)] focus:shadow-md"
        />
      </div>
