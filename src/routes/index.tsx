...
function LandingPage() {
  return (
    <main className="page-wrap flex min-h-[80vh] flex-col items-center justify-center px-4 py-12 text-center">
      <div className="rise-in mb-6 flex h-20 w-20 items-center justify-center rounded-3xl bg-[var(--mag-green)] shadow-lg">
      ...
      <div className="rise-in flex w-full max-w-xs flex-col gap-3" style={{ animationDelay: '240ms' }}>
        <Link
          to="/login"
          className="flex items-center justify-center gap-2 rounded-full bg-[var(--mag-green)] px-6 py-3.5 text-sm font-semibold text-white shadow-md transition hover:bg-[var(--mag-green-dark)] hover:shadow-lg no-underline"
        >
        ...
        <Link
          to="/login"
          className="flex items-center justify-center gap-2 rounded-full border border-[var(--mag-line)] bg-[var(--mag-card)] px-6 py-3.5 text-sm font-semibold text-[var(--mag-ink)] transition hover:bg-[var(--mag-surface)] no-underline"
        >
          Log In
        </Link>
      </div>
