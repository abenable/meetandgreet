...
function PrivacyPage() {
  return (
    <main className="page-wrap mx-auto min-h-[80vh] max-w-3xl px-4 py-6 md:px-6 md:py-8 pb-nav">
      <div className="mb-6 flex items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="min-w-0 flex-1 truncate text-center text-xl font-bold text-[var(--mag-ink)]">Privacy Policy</h1>
          <span aria-hidden="true" className="w-10 shrink-0" />
        </div>
      </div>

      <p className="mb-6 text-sm text-[var(--mag-ink-muted)]">Last updated: {new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</p>

      <div className="space-y-6 text-base leading-relaxed text-[var(--mag-ink-soft)]">
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">1. Introduction</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">2. Information We Collect</h2>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">3. How We Use Your Information</h2>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">4. Information Sharing</h2>
          <p className="mb-2">
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">5. Data Retention</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">6. Security</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">7. Your Rights and Choices</h2>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">8. Cookies and Tracking</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">9. Third-Party Links</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">10. Children&apos;s Privacy</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">11. Changes to This Policy</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">12. Contact Us</h2>
          <p>
