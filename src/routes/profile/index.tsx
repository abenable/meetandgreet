...
function ProfilePage() {
  ...
  const updateMutation = useMutation({
    mutationFn: async (updates: { bio?: string; job?: string; location?: string }) => {
  ...
  return (
    <main className="page-wrap px-4 py-4">
      ...
      <div className="mb-5 flex gap-2 overflow-x-auto hide-scrollbar pb-1">
        ...
        <button className="flex h-20 w-20 flex-shrink-0 flex-col items-center justify-center gap-0.5 rounded-xl bg-[var(--mag-green)] text-white dark:text-black transition hover:opacity-90">
