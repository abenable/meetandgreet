  ...
  return (
    <main className="page-wrap mx-auto min-h-[80vh] max-w-3xl px-4 py-6 md:px-6 md:py-8 pb-nav">
      ...
      <div className="space-y-6 text-base leading-relaxed text-[var(--mag-ink-soft)]">
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">1. Acceptance of Terms</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">2. Eligibility</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">3. User Accounts</h2>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">4. Acceptable Use</h2>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">5. Content and Conduct</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">6. Safety and Reporting</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">7. Termination</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">8. Disclaimers</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">9. Limitation of Liability</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">10. Changes to These Terms</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-[var(--mag-ink)]">11. Contact Us</h2>
          <p>
